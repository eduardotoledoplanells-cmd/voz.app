    ...
    return (
        <div style={{ backgroundColor: '#000', color: 'white', minHeight: '100vh', width: '100%', paddingBottom: '70px', overflowX: 'hidden' }}>
            ...
            <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
                ...
                {!isApproved ? (
                    <div style={{ textAlign: 'center', backgroundColor: 'rgba(255,255,255,0.05)', padding: '30px', borderRadius: '15px', marginBottom: '30px' }}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '30px', backgroundColor: 'rgba(76,217,100,0.05)', padding: '20px', borderRadius: '15px', border: '1px solid rgba(76,217,100,0.3)' }}>
                        <div style={{ backgroundColor: 'rgba(76,217,100,0.1)', width: '60px', height: '60px', borderRadius: '30px', display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '0 auto 10px' }}>
                            <span style={{ fontSize: '30px' }}>✅</span>
                        </div>
                        <h3 style={{ fontSize: '20px', fontWeight: 'bold' }}>Creador Oficial</h3>
                        <p style={{ color: 'gray', marginTop: '5px', fontSize: '14px' }}>Tu cuenta de Stripe está conectada y activa.</p>
                    </div>
                )}
