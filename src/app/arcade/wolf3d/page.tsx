...
import Wolf3DGame from '@/components/game/Wolf3DGame';
import Link from 'next/link';
import { useAuth } from '@/context/AuthContext';
import styles from './wolf3d.module.css';

export default function Wolf3DArcadePage() {
    const { user } = useAuth();
            ...
            <div style={{ width: '100%', margin: '0 auto' }}>
                ...
                <div style={{ marginTop: '40px', padding: '20px', background: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                    ...
                    <ul style={{ listStyle: 'inside', lineHeight: '1.6' }}>
                        ...
                        <li>Barra espaciadora para abrir puertas.</li>
                        <li>Control para disparar.</li>
                        <li>Mata enemigos para ganar ROBcoins (8 enemigos = 1 ROBcoin).</li>
