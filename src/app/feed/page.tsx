                ...
                >
                    ...
                    {isScrubbing && (
                        <div style={{
                            ...
                            <span style={{ color: '#FF0055' }}>{formatTime(scrubProgress * durationSec)}</span>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            borderRadius: '4px',
                            width: `${(isScrubbing ? scrubProgress : videoProgress) * 100}%`
                        }} />

                        {/* Red Dot (Thumb) with Glow */}
                        <div style={{
                            position: 'absolute',
                            left: `${(isScrubbing ? scrubProgress : videoProgress) * 100}%`,
                            top: '50%',
