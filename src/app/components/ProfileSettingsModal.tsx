                        ...
                        {editMode === 'country' && (
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                >
                                    ...
                                    <option value="Estados Unidos" disabled>Estados Unidos 🇺🇸 🔒 (Próximamente)</option>
                                    <option value="México" disabled>México 🇲🇽 🔒 (Próximamente)</option>
                                    <option value="Argentina" disabled>Argentina 🇦🇷 🔒 (Próximamente)</option>
                                    <option value="Colombia" disabled>Colombia 🇨🇴 🔒 (Próximamente)</option>
                                    <option value="Chile" disabled>Chile 🇨🇱 🔒 (Próximamente)</option>
                                    <option value="Perú" disabled>Perú 🇵🇪 🔒 (Próximamente)</option>
                                    <option value="Venezuela" disabled>Venezuela 🇻🇪 🔒 (Próximamente)</option>
                                    <option value="Ecuador" disabled>Ecuador 🇪🇨 🔒 (Próximamente)</option>
                                    <option value="Guatemala" disabled>Guatemala 🇬🇹 🔒 (Próximamente)</option>
                                    <option value="Cuba" disabled>Cuba 🇨🇺 🔒 (Próximamente)</option>
                                    <option value="República Dominicana" disabled>República Dominicana 🇩🇴 🔒 (Próximamente)</option>
                                    <option value="Bolivia" disabled>Bolivia 🇧🇴 🔒 (Próximamente)</option>
                                    <option value="Honduras" disabled>Honduras 🇭🇳 🔒 (Próximamente)</option>
                                    <option value="Paraguay" disabled>Paraguay 🇵🇾 🔒 (Próximamente)</option>
                                    <option value="El Salvador" disabled>El Salvador 🇸🇻 🔒 (Próximamente)</option>
                                    <option value="Nicaragua" disabled>Nicaragua 🇳🇮 🔒 (Próximamente)</option>
                                    <option value="Costa Rica" disabled>Costa Rica 🇨🇷 🔒 (Próximamente)</option>
                                    <option value="Puerto Rico" disabled>Puerto Rico 🇵🇷 🔒 (Próximamente)</option>
                                    <option value="Uruguay" disabled>Uruguay 🇺🇾 🔒 (Próximamente)</option>
                                    <option value="Panamá" disabled>Panamá 🇵🇦 🔒 (Próximamente)</option>
                                    <option value="Brasil" disabled>Brasil 🇧🇷 🔒 (Próximamente)</option>
                                    <option value="Francia" disabled>Francia 🇫🇷 🔒 (Próximamente)</option>
                                    <option value="Italia" disabled>Italia 🇮🇹 🔒 (Próximamente)</option>
                                    <option value="Alemania" disabled>Alemania 🇩🇪 🔒 (Próximamente)</option>
                                    <option value="Reino Unido" disabled>Reino Unido 🇬🇧 🔒 (Próximamente)</option>
                                    <option value="Portugal" disabled>Portugal 🇵🇹 🔒 (Próximamente)</option>
                                </select>
