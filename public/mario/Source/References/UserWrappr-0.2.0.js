...
(function (UserWrappr_1) {
        ...
        */
        ...
        UserWrappr.prototype.fixCustoms = function (customsRaw) {
            ...
            if (!isFinite(customs.height)) {
                ...
                // customs.height -= 84; // Removed for embedded play
            }
            return customs;
        };
        /* Page visibility
    ...
    (function (UISchemas) {
         ...
         */
        var AbstractOptionsGenerator = /** @class */ (function () {
            /**
         ...
         * of general buttons.
         */
        var OptionsButtonsGenerator = /** @class */ (function (_super) {
         ...
         */
        var OptionsTableGenerator = /** @class */ (function (_super) {
            __extends(OptionsTableGenerator, _super);
            function OptionsTableGenerator() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.optionTypes = {
                    "Boolean": _this.setBooleanInput,
                    "Keys": _this.setKeyInput,
                    "Number": _this.setNumberInput,
                    "Select": _this.setSelectInput,
                    "ScreenSize": _this.setScreenSizeInput
                };
                return _this;
            }
         ...
         */
        var LevelEditorGenerator = /** @class */ (function (_super) {
         ...
         */
        var MapsGridGenerator = /** @class */ (function (_super) {
