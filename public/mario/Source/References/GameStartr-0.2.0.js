...
(function (GameStartr_1) {
     ...
     */
    var GameStartr = /** @class */ (function (_super) {
        ...
        function GameStartr(settings) {
            ...
            if (settings.extraResets) {
                _this.resets.push.apply(_this.resets, settings.extraResets);
            }
            if (settings.resetTimed) {
                _this.resetTimed(_this, settings);
            }
            else {
                _this.reset(_this, settings);
            }
            return _this;
        }
        /* Resets
